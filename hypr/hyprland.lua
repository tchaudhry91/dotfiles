-- =============================================================
--  DEFAULT Hyprland config (template for NEW machines)
--
--  Based on qe93. To bring up a new machine:
--    1. cp hyprland.lua ~/.config/hypr/hyprland.lua
--    2. edit the MONITORS section and any hardware / input
--       sections for that host (GPU env, touchpad, sensitivity).
--
--  Existing per-host configs in this repo:
--    hyprland.qe93.lua      hyprland.qenitro.lua
--    hyprland.qecarbon.lua
-- =============================================================
...
--monitor=DP-1,3840x2160,1920x0,1.6
